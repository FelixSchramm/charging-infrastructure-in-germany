...
# --- ZEITREIHEN ---
CHART_START_YEAR = 2010  # Charts beginnen ab diesem Jahr; Älteres wird als Offset kumuliert.

# --- KARTE ---
MAP_CENTER = [51.16, 10.45]
MAP_BOUNDS = [[47.27, 5.87], [55.06, 15.04]]
MAP_ZOOM = 6
SIMPLIFY_TOLERANCE = 500  # Vereinfachung der Kreisgeometrien (in Einheiten des Quell-CRS).
TARGET_CRS = 4326
